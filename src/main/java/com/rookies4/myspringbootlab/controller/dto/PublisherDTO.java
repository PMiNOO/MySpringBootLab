...
public class PublisherDTO {
    ...
    // [GET /api/publishers] 에서만 사용할 DTO
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    @Builder
    ...
    // [GET /api/books] 내부에서 사용할 DTO (bookCount 없음)
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    @Builder
    public static class BookPublisherResponse {
        private Long id;
        private String name;
        private LocalDate establishedDate;
        private String address;

        public static BookPublisherResponse fromEntity(Publisher publisher) {
