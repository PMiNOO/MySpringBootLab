...
public class BookRepositoryTest {
    ...
    public void findBooksByAuthor() {
        ...
        Book book1 = Book.builder()
                ...
                .isbn("9780132350884")
                .build();
        book1.setBookDetail(BookDetail.builder().book(book1).build());
        ...
        Book book2 = Book.builder()
                ...
                .isbn("9780134494166")
                .build();
        book2.setBookDetail(BookDetail.builder().book(book2).build());
        ...
        Book book3 = Book.builder()
                ...
                .isbn("9780134685991")
                .build();
        book3.setBookDetail(BookDetail.builder().book(book3).build());
